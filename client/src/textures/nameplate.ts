...
// `color` defaults to white (hider/unassigned); callers re-bake this in red
// once a player's role is known to be "seeker", so the seeker's name always
// reads as a warning color to anyone who spots them.
export function createNameTexture(
  nickname: string,
  color = "#ffffff"
